...
public class SearchController {
    ...
    @GetMapping("/test")
    public ApiResponse<String> getTestResult() {
        String data = searchService.test();
        log.info("getting result: " + data);
        return ApiResponse.success(ResponseMessage.SUCCESS, data);
    }
